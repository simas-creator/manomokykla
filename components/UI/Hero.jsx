...
const Card = ({ type }) => {
  return (
    <Link href={type === "view" ? "/perziureti-mokyklas" : "/prideti-mokykla"}>
      <div
        className={`relative group  w-full sm:w-[350px] h-full z-[10]  ${
          type === "view" ? "grad-view" : "grad-rate"
        }`}
      >
        <div
        ...
        >
          ...
          <div
            className={`mb-5 flex h-16 w-16 items-center group-hover:scale-110 group group-hover:translate-x-2 duration-300 justify-center rounded-full ${
              type === "view" ? "bg-black" : "bg-primary"
            } shadow-md`}
          >
            {type === "view" ? (
              <svg
          ...
          <div className="mb-4">
            <h3
              className={`mb-2 text-xl font-bold ${
                type === "view" ? "text-black" : "text-primary"
              }`}
            >

  ...
  return (
    <>
      <section className="md:h-[100vh] flex relative flex-col md:flex-row">
        ...
        <Link
          className="text-2xl pb-16 pt-20 font-title text-center md:pt-44 md:w-1/2 bg-black md:text-3xl font-bold text-white"
          href={`/skydelis/laukia-patvirtinimo`}
        >
          Laukia patvirtinimo
        ...
        <Link
          className="text-2xl pb-16 pt-20 font-title text-center md:pt-44 md:w-1/2 bg-primary md:text-3xl font-bold text-white"
          href={`/skydelis/pranesimai`}
        >
          Pranešimai
